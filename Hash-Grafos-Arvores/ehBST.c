// Implementar a função eBinariaBusca que dada uma árvore binária verifique se a mesma respeita as restrições para que possa ser considerada uma árvore binária de busca. A função deve retornar true, quando for uma árvore binária de busca e false, caso contrário.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdbool.h>
